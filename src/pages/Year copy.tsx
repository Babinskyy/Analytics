          ...
          <IonRow className="ion-justify-content-center" >
            ...
            >
              <GraphSelect />
                ...
                <IonCol size="auto">
                <IonItem style={{ maxHeight: "750px", overflow: "scroll" }}>
                  ...
                  return barData.datasets[0].data[i] > 0 ? (
                    ...
                    >
                      <IonLabel>
                        ...
                        <div style={{opacity: "0.5"}}>{barData.date[i]}</div>
                      </IonLabel>
